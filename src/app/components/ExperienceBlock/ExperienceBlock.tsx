...
const ExperienceBlock = ({ title, text, tags }: ExperienceBlockProps) => {
    return (
        <div className="min-h-40 w-full mb-8 flex justify-center gap-10 p-5 rounded-l hover:bg-white-10">
            ...
            <div>
                ...
                <div className="flex justify-start">
                    {tags.map((tag: string, index: number) => (
                        <div className="bg-dark-green w-20 h-5 rounded-xl m-8 ml-0 mr-4 flex items-center justify-center">
