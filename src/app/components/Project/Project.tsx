...
const Project = ({ title, text, tags, imageName}: ProjectBlockProps) => {
    return (
        <div className="min-h-40 w-full max-w-2xl mb-8 mx-auto flex flex-col lg:flex-row lg:justify-center gap-5 lg:gap-6 p-5 rounded-l hover:bg-[#1c1b29]/10 hover:shadow-[0_0_2px_1px_rgba(255,255,255,0.1),0_0_4px_2px_rgba(255,255,255,0.1)] group">
