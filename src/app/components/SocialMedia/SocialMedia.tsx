  ...
  return (
    <ul className="flex justify-start gap-3 mt-8 lg:mt-48">
      <a href="https://github.com/Rabbok" target="_blank">
        <img
          className="h-5 w-5 lg:h-7 lg:w-7 transform transition-transform duration-300 hover:scale-125"
      ...
      {/* <a href="mailto:rabbokku@gmail.com" target="_blank">
        <img
          ...
          src="/img/4550857_email_gmail_mail_sending_yahoo_icon_negate.png"
          alt=""
        />
      </a> */}
    </ul>
